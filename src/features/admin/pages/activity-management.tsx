    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-bold tracking-tight">Quản lý Hoạt động</h1>
                <p className="text-sm text-muted-foreground">Theo dõi log hoạt động của hệ thống và người dùng.</p>
            </div>
